# Comparações de métodos de segmentação

Este documento cataloga as execuções usadas para comparar os métodos de
threshold e segmentação arterial em resolução média. Os runs permanecem em
`output/segmentation/runs/mid_res/fuzzy_comparison/`.
