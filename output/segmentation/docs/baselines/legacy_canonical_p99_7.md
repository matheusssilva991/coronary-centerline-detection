...
Este documento cataloga os resultados que formavam a referência oficial antes
da promoção da configuração P99.9. O nome destaca o percentil superior P99.7
presente nos snapshots; os três runs são históricos e não representam a
