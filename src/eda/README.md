...
| [aorta_solution_comparison.ipynb](aorta_solution_comparison.ipynb) | Comparar baseline, filtro com envelope e filtro com envelope mais level set refinado | Runs pareados de treino e validação e `config/aorta_visual_reviews.json` | Qualidade visual da aorta, sucesso dos óstios, Dice e deltas contra o baseline | Baixo |
