...
Este documento cataloga os runs da configuração promovida ao `canonical` e ao
baseline padrão em resolução média. Esta série também corresponde à referência
quantitativa do artigo.
