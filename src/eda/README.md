...
| [aorta_solution_comparison.ipynb](aorta_solution_comparison.ipynb) | Comparar visual e quantitativamente as soluções normal e agressiva para a aorta | Runs pareados de treino e validação e `config/aorta_visual_reviews.json` | Tabelas de transição e gráficos por subconjunto | Baixo |
