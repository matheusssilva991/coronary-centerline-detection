...
_LAZY_EXPORTS = {
    ...
    "detect_ostia": ".segmentation.pipeline_detection",
    "locate_aorta_circles": ".segmentation.pipeline_detection",
    "segment_aorta": ".segmentation.pipeline_detection",
    "compute_vesselness": ".segmentation.pipeline_preprocessing",
    "load_and_preprocess_image": ".segmentation.pipeline_preprocessing",
    "preprocess_ccta_volume": ".segmentation.pipeline_preprocessing",
    "segment_arteries_from_ostia": ".segmentation.pipeline_arteries",
    "segment_arteries_from_vesselness": ".segmentation.pipeline_arteries",
    "get_artery_postprocessing_stages": ".segmentation.pipeline_arteries",
    "summarize_aorta_circles": ".segmentation.pipeline_orchestration",
    # Comparison helpers
    ...
    "display_vesselness_summary": ".visualization.vesselness",
