...
| [aorta_circle_slice_analysis.ipynb](aorta_circle_slice_analysis.ipynb) | Comparar fatias, cobertura, raio e posição dos círculos entre aortas visualmente boas e ruins | Summary com métricas da aorta e rótulos visuais | Tabelas e gráficos no notebook | Baixo |
...
| [aorta_solution_comparison.ipynb](aorta_solution_comparison.ipynb) | Comparar a solução normal, o filtro agressivo, os filtros por cobertura e o level set adaptativo da aorta | Runs pareados de treino e validação e `config/aorta_visual_reviews.json` | Qualidade visual da aorta, sucesso dos óstios pelo CSV, Dice e deltas contra o normal | Baixo |
